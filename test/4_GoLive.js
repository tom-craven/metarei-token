const {
    TOKEN_SUPPLY,
    ONE_TOKEN, BURN_FR, PASS_PHRASE, SALE_PUBLIC_PERCENTAGE, SALE_PRIVATE_PERCENTAGE, SALE_LP_PERCENTAGE,
    SALE_LISTING_PERCENTAGE, MARKETING_PERCENTAGE, TEAM_PERCENTAGE, COMMUNITY_PERCENTAGE, RESERVE_PERCENTAGE,
    DEV_PERCENTAGE, AMOUNT_BOUGHT, COST_TOTAL, TOKEN_BOUGHT, toMajorUnit
...
contract("Metarei", (accounts) => {
    ...
    it('Should deploy smart contract', async () => {
        ...
        /**
         * @development calculating the Sale allocation.
         */
